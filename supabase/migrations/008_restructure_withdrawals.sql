-- Migration: Restructure Withdrawals System
--
-- Changes:
...
--
-- This migration prepares the system for the new structure:
-- Collections → YOUR INVENTORY
--   ├─ Distributions (CBAJ - record keeping only)
--   └─ Actual Withdrawals (YOUR giveaways - subtracts from stock)

-- ============================================================================
-- PART 1: Update master_inventory view (exclude current withdrawal_items)
-- ============================================================================
...
-- ============================================================================
-- PART 2: Rename withdrawals → distributions
-- ============================================================================
...
-- ============================================================================
-- PART 3: Create actual_withdrawals table for YOUR giveaways
-- ============================================================================

-- Create actual_withdrawals table
CREATE TABLE public.actual_withdrawals (
...
CREATE TABLE public.actual_withdrawal_items (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Create indexes
CREATE INDEX idx_actual_withdrawals_date ON public.actual_withdrawals(withdrawal_date DESC);
CREATE INDEX idx_actual_withdrawals_user ON public.actual_withdrawals(withdrawn_by);
CREATE INDEX idx_actual_withdrawal_items_withdrawal ON public.actual_withdrawal_items(withdrawal_id);
CREATE INDEX idx_actual_withdrawal_items_item ON public.actual_withdrawal_items(item_id);
...
-- ============================================================================
-- PART 4: Update master_inventory to include actual_withdrawals
-- ============================================================================
...
-- ============================================================================
-- PART 5: Add receipt_date to collections table
-- ============================================================================
...
-- Verify master_inventory structure
SELECT 'Master inventory columns:' AS status;
SELECT column_name, data_type
FROM information_schema.columns
WHERE table_name = 'master_inventory'
ORDER BY ordinal_position;

-- Verify receipt_date added to collections
SELECT 'Collections receipt_date:' AS status;
SELECT column_name, data_type, is_nullable
FROM information_schema.columns
WHERE table_name = 'collections' AND column_name = 'receipt_date';
